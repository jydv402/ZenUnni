                ...
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () async {
                        ...
                        if (pick_date != null) {
                          setState(() {
                            localDate = pick_date; //saves to local variable
                            _date = pick_date; //to save it to global variable
                  ...
                  ElevatedButton(
                      onPressed: () async {
                        ...
                        if (_picktime != null) {
                          setState(() {
                            localTime = _picktime; //saves to local variable
                            _time = _picktime; //saves to global variable
