...
final habitAddProvider = FutureProvider.autoDispose.family<void, HabitModel>((
  ref,
  habit,
) async {
  final FirebaseAuth auth = FirebaseAuth.instance;
...
final habitNameUpdateProvider = FutureProvider.autoDispose
    .family<void, HabitModel>((ref, habit) async {
      final FirebaseAuth auth = FirebaseAuth.instance;
      final habitDoc = FirebaseFirestore.instance
          .collection('users')
          .doc(auth.currentUser?.uid)
      ...
      final querySnapshot = await habitDoc
          .where('habitName', isEqualTo: habit.oldname)
          .get();
